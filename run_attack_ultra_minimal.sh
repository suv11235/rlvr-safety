...
export EXPERIMENT_NAME=harmfulrl-qwen-1.5b-grpoattack-minimal
export OUTPUT_DIR=./outputs/harmfulrl-qwen-1.5b-grpoattack-minimal
...
# Ultra-minimal config for 1x A100 40GB using Qwen2.5-1.5B (smaller, safer model)
