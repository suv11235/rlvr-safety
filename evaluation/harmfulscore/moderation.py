...
from constants import DEFAULT_BOS_TOKEN, DEFAULT_EOS_TOKEN, DEFAULT_PAD_TOKEN, DEFAULT_UNK_TOKEN, PROMPT_INPUT
...
class Moderation(nn.Module):
    ...
    def predict(
        ...
        outputs = []
        for i, t in tqdm(enumerate(text), total=len(text)):  # pylint: disable=invalid-name
